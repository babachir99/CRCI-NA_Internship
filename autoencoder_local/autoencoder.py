...
#pip install scikit-learn i used that
...
n = 1000000          # Size of train + val set
...
if os.path.exists("indices.npy"):
  ...
  #files.download('indices.npy') the datas will be automatically saved on indices.npy on local
...
'''
i will inable all the display until i find a new solution
  ...
  for i in tqdm(range(num_attempts)):
    ...
    for smile in smiles:
      ...
      if molecule:
        ...
        with open(f'drive/MyDrive/ms-chem-main/random_ligands.txt', 'r') as f:
          lines = f.readlines()

          if smile not in lines:
            with open(f'drive/MyDrive/ms-chem-main/random_ligands.txt', 'a') as f:
                f.writelines(smile + ",\n")
